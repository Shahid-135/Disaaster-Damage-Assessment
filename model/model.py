...
df_train = pd.read_table("/home/shahid/000.Damage Severity/embeddings/task_damage_text_img_train.tsv")
df_val = pd.read_table("/home/shahid/000.Damage Severity/embeddings/task_damage_text_img_dev.tsv")
df_test = pd.read_table("/home/shahid/000.Damage Severity/embeddings/task_damage_text_img_test.tsv")
...
train_image_raw = np.load("/home/shahid/000.Damage Severity/embeddings/CrisisMMD/Swin/train_feature_last_hidden_state.npy", allow_pickle=True)
val_image_raw = np.load("/home/shahid/000.Damage Severity/embeddings/CrisisMMD/Swin/val_feature_last_hidden_state.npy", allow_pickle=True)
test_image_raw = np.load("/home/shahid/000.Damage Severity/embeddings/CrisisMMD/Swin/test_feature_last_hidden_state.npy", allow_pickle=True)
...
handcraft_img_train = np.load("/home/shahid/000.Damage Severity/embeddings/1.Final_model/1.final_model/novel_features/train_handcrafted_features.npy", allow_pickle=True)
handcraft_img_val = np.load("/home/shahid/000.Damage Severity/embeddings/1.Final_model/1.final_model/novel_features/val_handcrafted_features.npy", allow_pickle=True)
handcraft_img_test = np.load("/home/shahid/000.Damage Severity/embeddings/1.Final_model/1.final_model/novel_features/test_handcrafted_features.npy", allow_pickle=True)

exp_img_train = np.load("/home/shahid/000.Damage Severity/embeddings/1.Final_model/1.final_model/explainability/train_exp_features.npy", allow_pickle=True)
exp_img_val = np.load("/home/shahid/000.Damage Severity/embeddings/1.Final_model/1.final_model/explainability/val_exp_features.npy", allow_pickle=True)
exp_img_test = np.load("/home/shahid/000.Damage Severity/embeddings/1.Final_model/1.final_model/explainability/test_exp_features.npy", allow_pickle=True)
